...
class FirestoreService{
  ...
  // Create
  Future<void> addPerson(String personsName, String personEmail, int personAge) {
    return persons.add({
  ...
  // Update
  Future<void> updatePerson(String personId, String personsName, String personEmail, int personAge) {
